...
const Certificate: React.FC<CertificateProps> = ({
  ...
  return (
    <div className="flex justify-center items-center">
      <div className={`w-[500px] h-[320px] bg-white border-[6px] border-gray-900 shadow-2xl relative p-4${user?.trade ? "" : "pointer-events-none opacity-10"
          }`}>
